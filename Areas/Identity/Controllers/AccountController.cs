...
namespace App.Areas.Identity.Controllers
{
    ...
    {
        private readonly UserManager<MyHoangTuan> _userManager;
        private readonly SignInManager<MyHoangTuan> _signInManager;
        private readonly IEmailSender _emailSender;
        private readonly ILogger<AccountController> _logger;

        public AccountController(
            UserManager<MyHoangTuan> userManager,
            SignInManager<MyHoangTuan> signInManager,
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new MyHoangTuan { UserName = model.UserName, Email = model.Email };
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                MyHoangTuan externalEmailUser = null;
                ...
                var user = new MyHoangTuan { UserName = model.Email, Email = model.Email };
