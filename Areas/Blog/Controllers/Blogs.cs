...
namespace App.Areas.Blog.Controllers
{
    ...
    public class Blogs : Controller
    {
        ...
        public Blogs(HoangTuanDB context)
        {
            _context = context;
        }
        ...
        {
            var hoangTuanDB = _context.Category.Include(c => c.ParentCategory);
            return View(await hoangTuanDB.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HoangTuanDB.Category'  is null.");
            }
            var category = await _context.Category.FindAsync(id);
            if (category != null)
            {
